  ...
  return (
    <section className="mx-auto max-w-3xl px-4 py-12 sm:px-6">
      ...
      <nav className="font-body text-sm text-navy-300">
        <Link href="/airlines" className="hover:text-green-600">
          Airlines
        </Link>{" "}
        / {airline.airlineName}
      </nav>
      ...
      <p className="mt-3 font-body text-navy-500">
        Here&apos;s {airline.airlineName}&apos;s current baggage allowance —
        checked against their published policy. Allowances change, so always
        confirm on{" "}
        <a
      ...
      <div className="mt-8 grid gap-4 sm:grid-cols-2">
        <div className="rounded-card border border-navy-100 bg-white p-5">
          <h2 className="font-heading text-base font-semibold text-navy-700">
            Cabin bag
          </h2>
        ...
        <div className="rounded-card border border-navy-100 bg-white p-5">
          ...
          <p className="mt-2 font-mono text-lg text-navy-700">
            {airline.personalItem.heightCm} ×{" "}
            {airline.personalItem.widthCm} ×{" "}
