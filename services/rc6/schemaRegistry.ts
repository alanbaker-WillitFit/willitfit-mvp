...
export const RC6_SCHEMA_REGISTRY: Readonly<Partial<Record<Rc6DatasetName, Rc6Schema>>> = Object.freeze({
  ...
  specialBaggageAll: {
    requiredHeaders: ["Item ID", "Item Rank", "Category", "Item Name", "Handling Classification", "Result Category", "Review Status", "Publish"],
    optionalHeaders: ["Item Subtype", "Typical Shape", "Special Handling Guidance", "Notes"],
  },
  countries: {
